...
SCRIPT = REPOSITORY_ROOT / "06-fitness-function/scripts/committed_mutation_integrity.py"
...
def test_success_and_failure(monkeypatch, capsys):
    ...
    class Report:
        ...
        head_ref = "HEAD"
        checked_mutations = 2
    monkeypatch.setattr(module, "assert_committed_mutation_integrity", lambda *a, **k: Report())
