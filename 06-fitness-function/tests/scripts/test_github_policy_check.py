...
SCRIPT = REPOSITORY_ROOT / "06-fitness-function/scripts/github_policy_check.py"
...
def test_bypass_actor_drift_fails(tmp_path, monkeypatch):
    for rel in (
        "00-governance/github/main-ruleset.json",
    ...
    path = tmp_path / "00-governance/github/main-ruleset.json"
