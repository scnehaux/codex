...
Create/manage it under the `scnehaux` organization:
...
## 5. Install the App only on `scnehaux/codex`
...
## 7. Local helper/evaluator directory

For bootstrap/preflight, keep the local helper outside the Codex checkout.
...
### Typical bootstrap helper contents
...
## 9. Generate/download the App private key
...
### 10.4 Restrict the private key ACL
...
Move/rename the downloaded key to:
...
## 12. Local authentication preflight
...
## 13. What the preflight should verify
...
7. Revoke/delete the old key in GitHub App settings.
...
## 16. Moving to a new workstation

Do not copy an unprotected private key through chat or email.

Preferred approaches:

- generate a fresh private key on/for the new trusted workstation, validate it, then revoke the previous key; or
...
If decommissioning the App entirely, also uninstall/revoke it through GitHub organization settings.

---

## 18. Next stage: Checks API write test
...
## 19. Next stage: local governance evaluator
...
## 20. Effective enforcement activation
...
## 22. Operator handoff information
...
governance/github/LOCAL-EVALUATOR-SETUP.md
