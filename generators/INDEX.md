...
| **generate_from_runtime_policy**  | Generate a markdown table from compiled runtime governance policy.                                                                                                                                              |
| **generate_from_x_global_config** | Compatibility wrapper; schema is no longer runtime-policy authority.                                                                                                                                            |
| **\_plain_runtime**               | _(No docstring provided)_                                                                                                                                                                                       |
...
| **process**                       | Iterate over all schemas in `schemas` and update their respective<br>Governance guidelines. If `check` is True, verify if they are in sync without writing.<br>Returns a list of out-of-sync documents (drift). |
| **main**                          | _(No docstring provided)_                                                                                                                                                                                       |
